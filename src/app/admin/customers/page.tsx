    ...
    <div className="max-w-7xl mx-auto px-6 py-8">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
        ...
        >
          ...
          <p className="text-2xl font-display font-bold text-white">{customers.length}</p>
        </motion.div>
        <motion.div
          initial={{ opacity: 0, y: 10 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <p className="text-2xl font-display font-bold text-purple-400">
            {customers.length > 0 ? Math.round(totalSpent / customers.length).toLocaleString() : 0}
          </p>
        </motion.div>
      </div>
                ...
                <div className="border-t border-white/5 bg-zinc-900/30 p-6">
                  ...
                  <div className="space-y-3">
                    {customer.recentBookings.map((booking) => (
                      <div
                        key={booking.id}
                        className="flex items-center justify-between p-4 rounded-xl bg-zinc-800/30 border border-white/5"
                      >
                        <div className="flex items-center gap-4">
